...
export class CreatePartComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.partForm = this.formBuilder.group({
      name: new FormControl(undefined, Validators.compose([Validators.required, Validators.maxLength(30)])),
      code: new FormControl(undefined, Validators.compose([Validators.required, Validators.maxLength(30)])),
